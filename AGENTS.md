# Codex Policy (Token Efficient)

Model & Subagent Execution Rules

## 1. Subagent Delegation Guidelines
- **Subagent Model Rule:** Whenever spawning a subagent for simple tasks (e.g., file search, directory traversal, running terminal commands, background log inspection), strictly use **Codex 4.5 Haiku**.
