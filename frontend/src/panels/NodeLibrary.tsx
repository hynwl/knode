...
import { NODE_CATEGORIES, searchNodes, type NodeCategory, type NodeDefinition } from '@/nodes/registry';
  ...
  return (
    <aside className="flex w-64 flex-none flex-col border-r border-border-soft bg-surface">
      <div className="flex flex-none items-center gap-2 border-b border-border-soft px-3 py-[10px]">
        ...
        />
        <button type="button" onClick={() => togglePanel('left')} aria-label="패널 접기" className="text-text-faint hover:text-text">
