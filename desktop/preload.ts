...
if (arg) {
  ...
  contextBridge.exposeInMainWorld('__KNODE_API_BASE__', apiBase);
}
...
contextBridge.exposeInMainWorld('__KNODE_SECRETS_BRIDGE__', {
...
// 존재 여부로 웹/데스크톱을 가른다.
contextBridge.exposeInMainWorld('__KNODE_ONBOARDING_BRIDGE__', {
